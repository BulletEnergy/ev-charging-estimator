...
export const PRICEBOOK: readonly PricebookItem[] = [
  ...
  {
    id: 'civil-ground-prep-cabinet',
    category: 'CIVIL',
    description: 'Civil Ground Prep for Cabinet / Switchgear Pad',
    catalogPrice: 3000,
    unit: 'EA',
    notes: 'Site-specific grading and prep',
    status: 'priced',
  },
  {
    id: 'civil-post-foundation-monolithic',
    category: 'CIVIL',
    description: 'Equipment Post Pads — Form / Steel / Monolithic Concrete',
    catalogPrice: 690,
    unit: 'CY',
    notes: 'Supercharger post foundations',
    status: 'priced',
  },
  {
    id: 'civil-cabinet-pad',
    category: 'CIVIL',
    description: 'Equipment Pads — Cabinets / Switchgear (Concrete)',
    catalogPrice: 450,
    unit: 'CY',
    notes: 'Cabinet and switchgear pads',
    status: 'priced',
  },
  ...
  },
  {
    id: 'elec-switchgear',
    category: 'ELEC',
    description: 'EV Switchgear / EV Lite Switchgear (Materials)',
    catalogPrice: 10000,
    unit: 'EA',
    notes: 'Site-specific; verify model and utility requirements.',
    status: 'priced',
    manualReview: true,
    manualReviewReason: 'Switchgear scope and vendor pricing varies by utility and ampacity',
  },
  {
    id: 'elec-meter-pad',
    category: 'ELEC',
    description: 'Meter Pad / Housing / Meter Assembly',
    catalogPrice: 7500,
    unit: 'EA',
    notes: 'From typical Supercharger site proposals',
    status: 'priced',
    manualReview: true,
    manualReviewReason: 'Utility-specific meter equipment and installation',
  },
  {
    id: 'elec-additional-bos',
    category: 'ELEC',
    description: 'Additional BOS (Balance of System)',
    catalogPrice: 6000,
    unit: 'EA',
    notes: 'Additional materials beyond standard BOS line',
    status: 'priced',
  },
  ...
  {
    id: 'eleclbr-install-supercharger',
    category: 'ELEC LBR',
    description: 'Install Switchgear / Cabinet / Posts / Pull Conductors / Wire / Commission (Supercharger)',
    catalogPrice: 9000,
    unit: 'EA',
    notes: 'Per install crew package; typical Supercharger site labor bundle',
    status: 'priced',
    manualReview: true,
    manualReviewReason: 'Scope may combine SG, cabinets, and posts — verify stall count vs packages',
  },
  ...
  {
    id: 'eleclbrmat-pvc-4in',
    category: 'ELEC LBR MAT',
    description: 'PVC Schedule 40 Conduit 4"',
    catalogPrice: 22,
    unit: 'LF',
    notes: 'Materials typical for large feeder runs',
    status: 'priced',
  },
  {
    id: 'eleclbrmat-pvc-3in',
    category: 'ELEC LBR MAT',
    description: 'PVC Schedule 40/80 Conduit 3"',
    catalogPrice: 20,
    unit: 'LF',
    notes: '',
    status: 'priced',
  ...
  {
    id: 'eleclbrmat-pvc-1in',
    category: 'ELEC LBR MAT',
    description: 'PVC Schedule 40 Conduit 1"',
    catalogPrice: 15,
    unit: 'LF',
    notes: '',
    status: 'priced',
  ...
  {
    id: 'eleclbrmat-wire-500mcm',
    category: 'ELEC LBR MAT',
    description: '500/600 MCM / Communication Wire (Materials)',
    catalogPrice: 7.62,
    unit: 'LF',
    notes: 'Large feeder; verify ampacity and code',
    status: 'priced',
    manualReview: true,
    manualReviewReason: 'Wire size and type must match engineering',
  },
  ...
  {
    id: 'misc-construction-support',
    category: 'MISC',
    description: 'Construction Fence / Roll Off / Portable Sanitation (LS)',
    catalogPrice: 6000,
    unit: 'EA',
    notes: 'Typical mobilization bundle on active sites',
    status: 'priced',
    manualReview: true,
    manualReviewReason: 'Duration and jurisdiction affect temporary facilities cost',
  },
  {
    id: 'misc-equipment-rental',
    category: 'MISC',
    description: 'Equipment Rental',
    catalogPrice: 3500,
    unit: 'EA',
    notes: 'Per rental period — verify days',
    status: 'priced',
    manualReview: true,
    manualReviewReason: 'Equipment type and rental length vary',
  },
